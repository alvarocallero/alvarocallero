...
```elixir
  ...
  def experience, do: ["12 years making cool software", "Error solver", "Backend it's my place", "Elixir lover"]
...
<img src="https://hexdocs.pm/oban/assets/logo.svg" alt="oban" width="60" height="60"/>
</p>
<div class="line">
 <p><hr background-color="forestgreen"></p>
</div>
